...
const projects = [
  ...
  },
  {
    ...
    repo: [
      "https://github.com/The-Nightman/IBDirect",
      "https://github.com/The-Nightman/IBDirectAPI",
    ],
  ...
  },
  {
    ...
    repo: [
      "https://github.com/JoeAshcroft/SILBA",
      "https://github.com/Kayphaz007/SILBA_BE",
    ],
    live: null,
    fullstack: true,
  },
  {
    image: edrJsonBuilder,
    name: "ElDewrito Resurgence Json Builder",
    body: "An Electron production app with an accessible UI/UX focus and automation, built to help server hosts build the required voting.json and mods.json files to host servers. Actively maintained with GHub actions for CI/CD pipeline.",
    repo: "https://github.com/The-Nightman/EDResurgence-VotingJSON-Builder",
    live: null,
    fullstack: false,
  },
  {
